...
def today():
    ...
    #   print(texpense)
      ...
      param1 = "SELECT TIME(date) as tn, amount FROM expenses WHERE userid =mail  AND DATE(date) = DATE(current timestamp) ORDER BY date DESC"
    ...
    #   expense = cursor.fetchall()
      ...
      param = "SELECT * FROM expenses WHERE userid = mail AND DATE(date) = DATE(current timestamp) ORDER BY date DESC"
      res = ibm_db.exec_immediate(conn, param)
      dictionary = ibm_db.fetch_assoc(res)
      expense = []
      while dictionary != False:
...
def month():
    ...
    #   print(texpense)
      ...
      param1 = "SELECT DATE(date) as dt, SUM(amount) as tot FROM expenses WHERE userid = mail AND MONTH(date) = MONTH(current timestamp) AND YEAR(date) = YEAR(current timestamp) GROUP BY DATE(date) ORDER BY DATE(date)"
      res1 = ibm_db.exec_immediate(conn, param1)
      dictionary1 = ibm_db.fetch_assoc(res1)
      texpense = []
    ...
    #   expense = cursor.fetchall()
      ...
      param = "SELECT * FROM expenses WHERE userid = mail AND MONTH(date) = MONTH(current timestamp) AND YEAR(date) = YEAR(current timestamp) ORDER BY date DESC"
      res = ibm_db.exec_immediate(conn, param)
      dictionary = ibm_db.fetch_assoc(res)
      expense = []
      while dictionary != False:
...
def year():
    ...
    #   print(texpense)
      ...
      param1 = "SELECT MONTH(date) as mn, SUM(amount) as tot FROM expenses WHERE userid = mail AND YEAR(date) = YEAR(current timestamp) GROUP BY MONTH(date) ORDER BY MONTH(date)"
      res1 = ibm_db.exec_immediate(conn, param1)
      dictionary1 = ibm_db.fetch_assoc(res1)
      texpense = []
      ...
      param = "SELECT * FROM expenses WHERE userid = mail AND YEAR(date) = YEAR(current timestamp) ORDER BY date DESC"
      res = ibm_db.exec_immediate(conn, param)
      dictionary = ibm_db.fetch_assoc(res)
      expense = []
      while dictionary != False:
